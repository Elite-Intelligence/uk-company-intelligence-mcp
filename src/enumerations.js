/**
 * Enumeration mappings sourced from:
 * https://github.com/companieshouse/api-enumerations (constants.yml)
 * These translate API codes into human-readable descriptions.
 */
...
export function resolveEnum(map, code) {
  if (!code) return null;
